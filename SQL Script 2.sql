...
CREATE TABLE IF NOT EXISTS "Dependent" (
	...
	FOREIGN KEY("EmpSSN") REFERENCES "Employee"("EmpSSN") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "Works_in" (
	...
	"deptNum"	INT NOT NULL,
	UNIQUE("EmpSSN"),
	FOREIGN KEY("deptNum") REFERENCES "Department"("deptNum") ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY("EmpSSN") REFERENCES "Employee"("EmpSSN") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "Works_on" (
	...
	"projName"	VARCHAR(255) NOT NULL,
	"projNum"	INT NOT NULL,
	FOREIGN KEY("projName","projNum") REFERENCES "Projects"("projName","projNum") ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY("EmpSSN") REFERENCES "Employee"("EmpSSN") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "Manages" (
	...
	UNIQUE("EmpSSN"),
	FOREIGN KEY("deptNum") REFERENCES "Department"("deptNum") ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY("EmpSSN") REFERENCES "salariedEmp"("EmpSSN") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "Employee" ("EmpSSN","DOB","FName","Mint","LName","Address") VALUES ('987654321','1992-08-10','Jane','B','Doe','456 Elm St'),
...
INSERT INTO "Dependent" ("Name","Relationship","EmpSSN") VALUES ('Jenna W. Smith','Child','987654321'),
...
INSERT INTO "hourlyEmp" ("hourlyPay","EmpSSN") VALUES (19.75,'987654321'),
 (22.25,'234567890'),
 (12.75,'345678901'),
 (20.0,'901234567');
